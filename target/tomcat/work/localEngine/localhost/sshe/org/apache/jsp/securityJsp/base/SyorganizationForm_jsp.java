...
public final class SyorganizationForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	if (id == null) {
      ...
      out.write("\t\t\t\turl = sy.contextPath + '/base/syorganization!update.sy';\r\n");
      out.write("\t\t\t} else {\r\n");
      out.write("\t\t\t\turl = sy.contextPath + '/base/syorganization!save.sy';\r\n");
      out.write("\t\t\t}\r\n");
      ...
      out.write("\t\t\t});\r\n");
      out.write("\t\t\t$.post(sy.contextPath + '/base/syorganization!getById.sy', {\r\n");
      ...
      out.write("\t\t\t\t\t\t'data.address' : result.address,\r\n");
      ...
      out.write("\t\t\t\t\t<td><input name=\"data.code\" /></td>\r\n");
      out.write("\t\t\t\t\t<th>顺序</th>\r\n");
      ...
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<th>上级机构</th>\r\n");
      out.write("\t\t\t\t\t<td><select id=\"syorganization_id\" name=\"data.syorganization.id\" class=\"easyui-combotree\" data-options=\"editable:false,idField:'id',textField:'name',parentField:'pid',url:'");
      out.print(contextPath);
      out.write("/base/syorganization!doNotNeedSecurity_comboTree.sy'\" style=\"width: 155px;\"></select><img class=\"iconImg ext-icon-cross\" onclick=\"$('#syorganization_id').combotree('clear');\" title=\"清空\" /></td>\r\n");
      out.write("\t\t\t\t\t<th>机构图标</th>\r\n");
      ...
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<th>机构地址</th>\r\n");
      out.write("\t\t\t\t\t<td><input name=\"data.address\" /></td>\r\n");
      out.write("\t\t\t\t\t<th></th>\r\n");
      out.write("\t\t\t\t\t<td></td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t</table>\r\n");
