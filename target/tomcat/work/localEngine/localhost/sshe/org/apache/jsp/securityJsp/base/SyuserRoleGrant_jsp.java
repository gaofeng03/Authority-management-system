...
public final class SyuserRoleGrant_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	if (id == null) {
      ...
      out.write("\t\t}\r\n");
      out.write("\t\t$.post(sy.contextPath + '/base/syuser!grantRole.sy', {\r\n");
      ...
      out.write("\t\t});\r\n");
      out.write("\t\t$('#tree').tree({\r\n");
      out.write("\t\t\turl : sy.contextPath + '/base/syrole!doNotNeedSecurity_getRolesTree.sy',\r\n");
      ...
      out.write("\t\t\t\t$.post(sy.contextPath + '/base/syrole!doNotNeedSecurity_getRoleByUserId.sy', {\r\n");
      out.write("\t\t\t\t\tid : $(':input[name=\"data.id\"]').val()\r\n");
      out.write("\t\t\t\t}, function(result) {\r\n");
      out.write("\t\t\t\t\tif (result) {\r\n");
