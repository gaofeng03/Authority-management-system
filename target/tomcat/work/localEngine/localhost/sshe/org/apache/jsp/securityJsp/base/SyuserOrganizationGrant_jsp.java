...
public final class SyuserOrganizationGrant_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	if (id == null) {
      ...
      out.write("\t\t}\r\n");
      out.write("\t\t$.post(sy.contextPath + '/base/syuser!grantOrganization.sy', {\r\n");
      ...
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t$pjq.messager.alert('提示', '修改成功！', 'info');\r\n");
      out.write("\t\t}, 'json');\r\n");
      out.write("\t};\r\n");
      out.write("\t$(function() {\r\n");
      ...
      out.write("\t\t});\r\n");
      out.write("\t\t$('#tree').tree({\r\n");
      out.write("\t\t\turl : sy.contextPath + '/base/syorganization!doNotNeedSecurity_getSyorganizationsTree.sy',\r\n");
      ...
      out.write("\t\t\t\t$.post(sy.contextPath + '/base/syorganization!doNotNeedSecurity_getSyorganizationByUserId.sy', {\r\n");
      out.write("\t\t\t\t\tid : $(':input[name=\"data.id\"]').val()\r\n");
      out.write("\t\t\t\t}, function(result) {\r\n");
      out.write("\t\t\t\t\tif (result) {\r\n");
